...
def save_url_message(chat_history_id, sender_type, url):
    conn, cursor = get_db_connection_and_cursor()

    cursor.execute('INSERT INTO messages (chat_history_id, sender_type, message_type, url_content) VALUES (?, ?, ?, ?)',
                   (chat_history_id, sender_type, 'url', url))
